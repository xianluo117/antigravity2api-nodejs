...
import { getPrefixedGeminiCliModels } from "../utils/modelRouting.js";
...
function handleModelsRequestOpenAI(req, res) {
  try {
    ...
    const models = getPrefixedGeminiCliModels();
...
router.post("/v1/chat/completions", (req, res) =>
  handleGeminiCliRequest(req, res, "openai"),
);
...
router.post("/v1/messages", (req, res) =>
  handleGeminiCliRequest(req, res, "claude"),
);
